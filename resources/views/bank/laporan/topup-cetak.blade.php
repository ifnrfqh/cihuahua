...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title" style="text-align: center"><a href="#" onclick="window.print();" style="color:black;">Laporan Riwayat Top Up</a></h4>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        window.addEventListener('afterprint', function() {
            ...
            window.location.href = '{{ route('topup.harian') }}';
        });
